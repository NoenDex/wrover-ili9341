...
#define TOUCH_CMD_X_READ 0b10010000 /* 0xd0 */
#define TOUCH_CMD_Y_READ 0b11010000 /* 0x90 */

#define TFT_HOR_RES CONFIG_WIDTH
#define TFT_VER_RES CONFIG_HEIGHT
...
typedef struct
{
	...
	spi_device_handle_t _TouchHandle;
} TFT_t;
